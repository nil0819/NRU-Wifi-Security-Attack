...
void
LbtAccessManagerEdThresholdTest::SpectrumWifiPhyRxSuccess (Ptr<WifiPsdu> p, double snr, WifiTxVector txVector, std::vector<bool> perMpduStatus)
{
  NS_FATAL_ERROR ("Should be unreachable; Wi-Fi rx reception disabled");
}

void
LbtAccessManagerEdThresholdTest::SpectrumWifiPhyRxFailure (Ptr<WifiPsdu> p)
{
  NS_FATAL_ERROR ("Should be unreachable; Wi-Fi rx reception disabled");
}
