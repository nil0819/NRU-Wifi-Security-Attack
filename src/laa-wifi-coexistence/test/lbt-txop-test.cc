...
LbtTxopTestCase::DoRun (void)
{
  ...
  //Config::Connect ("/NodeList/0/DeviceList/0/LteEnbPhy/ReservationSignal", MakeBoundCallback (&LteTestReservationSignalCallback, this)); //FIXME
  //Config::Connect ("/NodeList/0/DeviceList/0/LteEnbPhy/DataSent", MakeBoundCallback (&LteDataTracedCallback, this)); //FIXME
  //Config::Connect ("/NodeList/0/DeviceList/0/LteEnbPhy/Txop", MakeBoundCallback (&LteTestTxOpCallback, this)); //FIXME
